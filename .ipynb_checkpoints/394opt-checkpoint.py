...
print((Visual.groupby('State').sum()['annual_ghg_emissions']['CA'] - 361000000000000)/ 361000000000000)
print((Visual.groupby('State').sum()['annual_ghg_emissions']['MN'] - 89300000000000) / 89300000000000)
print((Visual.groupby('State').sum()['annual_ghg_emissions']['TX'] - 654000000000000) / 654000000000000)